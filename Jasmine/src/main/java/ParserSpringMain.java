...
public class ParserSpringMain {
    ...
    // sourceDirectory 和 dependencyDirectory 指定了待测试项目的源代码目录和依赖包目录。
    ...
    public static void main(String[] args) {
        ...
        String path  = "/home/haocheng/personal/Research/projects/Jasmine/src/main/resources/config.properties";
